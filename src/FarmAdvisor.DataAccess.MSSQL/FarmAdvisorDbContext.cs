...
public class FarmAdvisorDbContext : DbContext
{
    ...
    {
        optionsBuilder.UseSqlServer("Server=0.0.0.0,5500;Database=FarmAdvisor;User Id=SA;Password=Pass_Word;MultipleActiveResultSets=true;TrustServerCertificate=true");
    }
}